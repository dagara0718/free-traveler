# MANUAL-CHECK-EXTERNAL-LINKS — 외부 링크 새 탭 동작 점검
...
## Context
외부 링크 새 탭 동작 점검. 이 Task는 자동화가 어려운 항목을 브라우저에서 수동으로 점검한다. 대상 범위: SCR-003. 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 59에 대응한다.

## Project Scope
Implementation Status: **IMPLEMENT** (`docs/PROJECT_SCOPE.md`, `docs/UIUX_TRACEABILITY.md` 기준).

## Requirement Ref
REQ-FUNC-016,REQ-FUNC-018,REQ-FUNC-024,REQ-FUNC-026
...
## Functional AC
항공·숙소 CTA가 새 탭+`noopener,noreferrer`로 열림, opener 접근 불가 확인
