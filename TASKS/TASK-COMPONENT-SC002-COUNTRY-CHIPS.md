# COMPONENT-SC002-COUNTRY-CHIPS — 방문국가 30개 권역별 Chip
...
## Context
방문국가 30개 권역별 Chip. 이 Task는 하나 이상의 Page Owner Task가 의존하는 화면 구성요소를 구현한다. 대상 범위: SCR-002. 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 18에 대응한다.
...
## Test Cases
- Functional AC(`30개국, 4권역(아시아/유럽/북미/오세아니아) 그룹`)를 충족하는 동작 확인
- 검증 경로: 수동 QA
