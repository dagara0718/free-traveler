# TEST-RLS-BASIC — Supabase RLS 통합 테스트
...
## Context
Supabase RLS 통합 테스트. 이 Task는 Supabase RLS 통합 테스트를 작성한다. 대상 범위: 5개 Screen 공통. 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 53에 대응한다.
...
## Functional AC
역할별(Guest/Member/작성자/Moderator/Admin) 접근 시나리오 전부 통과
...
## Test Cases
- 역할별(Guest/Member/작성자/Moderator/Admin) 긍정/부정 접근 시나리오 각각 1개 이상
