# COMPONENT-SC005-PROFILE — Member 프로필 Tab
...
## Context
Member 프로필 Tab. 이 Task는 하나 이상의 Page Owner Task가 의존하는 화면 구성요소를 구현한다. 대상 범위: SCR-005. 이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 31에 대응한다.
...
## Functional AC
닉네임/연령대 필수, 성별 선택, 스타일 필수, 성인확인 배지
...
## Test Cases
- Functional AC(`닉네임/연령대 필수, 성별 선택, 스타일 필수, 성인확인 배지`)를 충족하는 동작 확인
- 검증 경로: E2E-MATE-AUTH
